...
P: Write a method that takes an int and returns the sum of its digits

E:

puts sum(23) == 5
puts sum(496) == 19
puts sum(123_456_789) == 45 => why the underscores?

D:
input: int (possibly seperated by underscores)
output: int
can't use basic iteraters.
